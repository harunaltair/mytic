...
class BookingController extends Controller
{
    ...
    public function bookingStore(StoreBookingRequest $request, Workshop $workshop)
    {
        ...
        try{
            ...
            return redirect()->back()->withErrors(['error' => 'Failed to process booking. Please try again']);
        }
    }
    ...
    public function paymentStore(StorePaymentRequest $request)
    {
        ...
        try{
            ...
            return redirect()->back()->withErrors(['error' => 'Failed to process payment. Please try again'. $e->getMessage()]);
        }
    }
